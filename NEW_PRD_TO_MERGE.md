...
2. The Service processes the image/data, utilizing AI services as required.  
3. The Service returns a JSON object containing the coordinates of the detected rooms.  
4. The React front-end renders the automatically-created room boundaries on the blueprint visualization.
...
4. **AI Documentation:** Detailed documentation of the specific **AI/ML services** and configuration settings used.
